package com.evaristo.androidismidterm;
...
public class MainActivity extends AppCompatActivity implements TextView.OnEditorActionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //seekbar inner class
        class MilesSeekbar extends SeekBar {
            @Override
    ...
    public void onResume() {
        ...
        miles = savedValues.getInt("miles",miles);
        feet = savedValues.getInt("feet",feet);
        inches = savedValues.getInt("inches",inches);

        //set instance variables to their widgets
        //set weight edit text
        weightEditText.setText(weight);

        //set miles seekbar
        milesSeekBar.setProgress(miles);

        //set feet spinner and inches spinner
        int ftPos = feet -1;
        feetSpinner.setSelection(ftPos);

        int inPos = inches -1;
        inchesSpinner.setSelection(inPos);
